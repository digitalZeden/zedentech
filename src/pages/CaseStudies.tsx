import { ArrowRight, ChevronDown, ChevronUp , ChevronRight} from "lucide-react";import Navbar from "@/components/Navbar";
...
const EnhancedCaseStudyCard = ({ title, client, industry, excerpt, imageUrl, slug, tags }) => {
  ...
  return (
    <div className="overflow-hidden rounded-lg shadow-md transition-all duration-300 hover:shadow-lg bg-white dark:bg-navy-800">
      <div className="aspect-[16/9] overflow-hidden relative">
        <Badge className="absolute top-4 right-4 z-10 bg-navy-600 text-white">{industry}</Badge>
        <img 
      ...
      <div className="p-6">
        ...
        <div className={`text-gray-600 dark:text-gray-200 ${expanded ? '' : 'line-clamp-3'}`}>
          {excerpt}
        </div>
        
        <div className="mt-4 flex flex-wrap gap-2">
          {tags.map((tag, i) => (
            <Badge key={i} variant="outline" className="bg-gray-100 dark:bg-navy-700 text-xs">
              {tag}
            </Badge>
          ))}
        </div>
...
const caseStudies = [
  {
    ...
    industry: "Education",
    excerpt: "Future-Ready Learning Through Digital Transformation. We modernize Ed-Tech platforms with cloud-based solutions, AI-driven personalization, and seamless LMS integrations to enhance engagement and scalability.",
    imageUrl: "./lms.jpg",
    slug: "financial-digital-transformation",
    tags: ["Digital Transformation", "Ed-Tech", "Cloud Solutions", "Operational Efficiency"]
  },
  {
    title: "Mobile Application Development",
    client: "Precision Scientific Equipment",
    industry: "Manufacturing",
    excerpt: "Precision Calibration at Your Fingertips. Our iPad app streamlines scientific equipment calibration with step-by-step guidance, automated documentation, and real-time accuracy validation.",
  ...
  },
  {
    ...
    industry: "Healthcare",
    excerpt: "Secure Patient Data with HIPAA-Compliant Protection. We implement robust cybersecurity measures tailored for healthcare systems, including risk assessments, access controls, and encryption to safeguard PHI.",
  ...
  },
  {
    ...
    industry: "Manufacturing",
    excerpt: "Revolutionize Valve Production with Smart IoT Solutions. We implement cutting-edge IoT sensors and real-time monitoring systems to optimize your manufacturing efficiency and quality control.",
    imageUrl: "./iot.jpg",
...
// Filter options
const industries = ["All Industries", "Education", "Manufacturing", "Healthcare"];
const solutionTypes = ["All Solutions", "Digital Transformation", "Mobile Development", "Cybersecurity", "IoT"];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8">
              Explore how we've partnered with organizations across industries to solve complex challenges and deliver exceptional results.
            </p>
...
>
  <a href="#case-studies">View Case Studies</a>
      ...
      <section className="py-16 px-4 bg-white dark:bg-navy-900" id="case-studies">
        <div className="container mx-auto">
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See how we transformed business operations and outcomes through innovative technology solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center bg-navy-50 dark:bg-navy-800/40 p-8 rounded-2xl">
            <div className="relative rounded-xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 p-6 z-20 text-white">
                ...
                <h3 className="text-2xl font-bold">Digital Transformation for Ed-Tech Company</h3>
              </div>
            </div>
            
            <div className="space-y-6 px-4">
              <Badge variant="outline" className="border-crimson-500 text-crimson-500 px-3 py-1">Client: Millionaire's Academy</Badge>
              <h3 className="text-2xl md:text-3xl font-bold">Future-Ready Learning Platform</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We modernized an Ed-Tech platform with cloud-based solutions, AI-driven personalization, and seamless LMS integrations to enhance engagement and scalability. Our tailored approach bridged pedagogy with technology to create immersive, data-informed learning experiences.
              </p>
              
              <div className="flex flex-wrap gap-2 py-3">
                {caseStudies[0].tags.map((tag, i) => (
                  <Badge key={i} className="bg-navy-100 dark:bg-navy-700 text-navy-700 dark:text-white">
                    {tag}
                  </Badge>
                ))}
              </div>
        ...
        <div className="container mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Explore more examples of how our tailored solutions have helped businesses achieve their goals
            </p>
          </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl relative">
              <div className="text-6xl text-crimson-400 absolute top-6 left-6 opacity-30">"</div>
              <div className="text-6xl text-crimson-400 absolute bottom-6 right-6 opacity-30 rotate-180">"</div>
              ...
              <div className="flex items-center">
                <div className="w-16 h-16 rounded-full bg-gray-500 mr-4 overflow-hidden">
                  <img src="/api/placeholder/64/64" alt="Client" className="w-full h-full object-cover" />
                </div>
                <div>
                  <div className="font-bold text-lg">Abdul Razzaq</div>
                  <div className="text-crimson-300">CEO, Millionaire's Academy</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-navy-600 to-navy-800 p-8 md:p-12 shadow-lg">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
                Let's discuss how our tailored IT solutions can help you achieve your business goals and drive innovation.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button asChild size="lg" className="bg-crimson-500 hover:bg-crimson-600 text-lg">
